...
const PLACES = [
  {
    id: "bukchon",
    name: { ko: "북촌한옥마을", en: "Bukchon Hanok Village" },
    category: "traditional",
    lat: 37.5826,
    lng: 126.983,
    address: "서울 종로구 계동길 37",
    summary: {
      ko: "도입부/배경에 자주 등장하는 전통 한옥 골목.",
      en: "Traditional hanok alleys frequently seen in opening/background shots.",
    },
    ref: "Seoul Mediahub",
  },
  {
    id: "nseoul",
    name: { ko: "N서울타워", en: "N Seoul Tower" },
    category: "landmark",
    lat: 37.5512,
    lng: 126.9882,
    ...
    summary: {
      ko: "서울의 상징적 야경 포인트.",
      en: "Iconic night view landmark of Seoul.",
    },
    ref: "Seoul Mediahub",
  },
  {
    id: "coex",
    name: { ko: "코엑스 3D 스크린", en: "COEX 3D Wave Screen (K-pop Square)" },
    category: "digital",
    lat: 37.5112,
    lng: 127.0592,
    address: "서울 강남구 영동대로 511",
    summary: {
      ko: "거대한 3D 파도 화면으로 유명한 스폿.",
      en: "Famous for the giant 3D ‘wave’ screen.",
    },
    ref: "Seoul Mediahub",
  },
  {
    id: "jamsil-hangang",
    name: { ko: "잠실 한강공원 야경", en: "Jamsil Hangang Park Night View" },
    category: "river",
    lat: 37.5164,
    lng: 127.0735,
    address: "서울 송파구 한가람로 65",
    summary: {
      ko: "한강 야경과 도심 스카이라인이 펼쳐지는 장소.",
      en: "Night vistas over the Han River and Seoul skyline.",
    },
    ref: "Seoul Mediahub",
  },
  {
    ...
    summary: {
      ko: "성곽길과 함께 서울 도심이 시원하게 보이는 공원.",
      en: "City panoramas along Seoul Fortress Wall trails.",
    },
    ref: "Seoul Mediahub",
  },
  {
    id: "cheongdam-bridge",
    name: { ko: "청담대교 지하철 구간", en: "Cheongdam Bridge Subway Section" },
    category: "bridge",
    lat: 37.526,
    lng: 127.047,
    address: "강남구↔광진구",
    summary: {
      ko: "한강 위를 달리는 지하철 장면의 배경.",
      en: "Subway run over the Han river in the film.",
    },
    ref: "Seoul Mediahub",
  },
  {
    id: "myeongdong",
    name: { ko: "명동거리", en: "Myeongdong Street" },
    category: "shopping",
    lat: 37.5637,
    lng: 126.9852,
    address: "서울 중구 명동길 일대",
    summary: {
      ko: "네온 사인과 인파로 가득한 메인 스트리트.",
      en: "Neon-lit main shopping drag crowded with visitors.",
    },
    ref: "Seoul Mediahub",
  },
  {
    id: "olympic-main",
    name: { ko: "서울올림픽주경기장", en: "Seoul Olympic Main Stadium" },
    category: "stadium",
    lat: 37.515,
    lng: 127.073,
    address: "서울 송파구 올림픽로 25",
    summary: {
      ko: "공연·액션 전개가 어울리는 대형 경기장.",
      en: "Grand venue fit for performance and action set-pieces.",
    },
    ref: "Seoul Mediahub",
  },
  {
    id: "lotte-tower",
    name: { ko: "롯데월드타워", en: "Lotte World Tower" },
    category: "landmark",
    lat: 37.5133,
    lng: 127.1028,
    address: "서울 송파구 올림픽로 300",
    summary: {
      ko: "123층 초고층 타워. 전망대 시그니처 뷰.",
      en: "123-story supertall with a signature observatory view.",
    },
    ref: "Seoul Mediahub",
  },
  {
    ...
    summary: {
      ko: "뚝섬 일대 장면의 거점.",
      en: "Anchor for scenes around Ttukseom area.",
    },
    ref: "Seoul Mediahub",
  },
];
...
export default function App() {
  ...
  return (
    <div className="w-full h-screen flex flex-col">
      ...
      {/* Body */}
      <div className="flex-1 grid md:grid-cols-[380px_1fr] grid-rows-1">
        {/* Sidebar */}
      ...
      <footer className="px-4 py-2 text-[11px] text-gray-500 border-t bg-white/70">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <a
            href="https://mediahub.seoul.go.kr/archives/2015242"
            target="_blank"
            rel="noreferrer"
            className="underline"
          >
